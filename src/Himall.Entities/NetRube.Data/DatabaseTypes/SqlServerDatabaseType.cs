...
namespace NetRube.Data.DatabaseTypes
{
    ...
    class SqlServerDatabaseType : DatabaseType
    {
        ...
        public override string DATEDIFFSyntax(string date1, string date2)
        {
            return string.Format("DATEDIFF(day,{0},{1})", date1, date2);
        }
        ...
        public override string BuildTopSql(int take, bool dist, string selectColumns, string tableName, string joins, string where, string groupby, string having, string orderby, List<object> args)
        {
        ...
        /// <param name="args">SQL 查询用的参数</param>
        /// <returns>最终可以执行的 SQL 查询语句</returns>
        public override string BuildPagedSql(long skip, long take, bool dist, string selectColumns, string tableName, string joins, string where, string groupby, string having, string orderby, List<object> args)
        {
