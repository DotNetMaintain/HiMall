...
namespace NetRube.Data
{
    ...
    public class DelBuilder<T> where T : IModel
    {
        ...
        public int Execute()
        {
            ...
            var sql = " {2} DELETE FROM {0} {1} ; {3} ".F(__db.GetTableName<T>(), this.GetWhere(), __FOREIGN_KEY_CHECKS ? ENABLED_FOREIGN_KEY_CHECKS : "", __FOREIGN_KEY_CHECKS ? DISABLED_FOREIGN_KEY_CHECKS : "");
