...
namespace NetRube.Data.Internal
{
    ...
    abstract class DatabaseType
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual string DATEDIFFSyntax(string date1, string date2)
        {
        ...
        public virtual string BuildTopSql(int take, bool dist, string selectColumns, string tableName, string joins, string where, string groupby, string having, string orderby, List<object> args)
        {
        ...
        /// <param name="args">SQL 查询用的参数</param>
        /// <returns>最终可以执行的 SQL 查询语句</returns>
        public virtual string BuildPagedSql(long skip, long take, bool dist, string selectColumns, string tableName, string joins, string where, string groupby, string having, string orderby, List<object> args)
        {
