...
namespace Himall.DTO.Product
{
    public class Product
    {
        ...
        /// 是否含保险
        /// </summary>
        public bool IsHadHPV { get; set; }
        //18-26岁导入的保险同意书名称
        public string HPVY { get; set; }
        //27-45岁导入的保险同意书名称
        public string HPVO { get; set; }
        //18-26保险公司名称
        ...
        //保险年龄段
        public string Insurancey_age { get; set; }
        //保险年龄段
        public string Insuranceo_age { get; set; }
        ...
        public ShopInfo Himall_Shops { get; set; }
        ...
        ///保险
        /// </summary>
        public List<DTO.Insurance> Insurance { get; set; }
