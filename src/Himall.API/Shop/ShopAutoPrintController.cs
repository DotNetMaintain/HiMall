    ...
    public class ShopAutoPrintController : ShopApiControllerWithHub<PrintHub>
    {
        ...
        public void GetPrintBroadcastShape(string userKey)
        {
            ...
            if (currentInfo != null)
            {
                ...
                if (shopInfo != null)
                {
                    currentInfo.IsAutoPrint = shopInfo.IsAutoPrint.HasValue ? shopInfo.IsAutoPrint.Value : false;
                    currentInfo.PrintCount = shopInfo.PrintCount.HasValue ? shopInfo.PrintCount.Value : 0;
        ...
        public object PostUpdteAutoPrint(ShopBranch info)
        {
            ...
            if (shopInfo != null)
            {
                ...
                ShopApplication.UpdateShopPrint(shopInfo);
