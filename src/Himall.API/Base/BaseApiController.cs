...
namespace Himall.API
{
    ...
    public class BaseApiController<TUser> : HiAPIController<TUser>
    {
        ...
        public object GetPhoneOrEmailCheckCode(string contact, string id = null, string imageCheckCode = null, bool checkBind = false)
        {
            ...
            if (checkBind && Application.MessageApplication.GetMemberContactsInfo(pluginInfo.PluginId, contact, MemberContactsInfo.UserTypes.General) != null)
            {
    ...
    public class BaseApiController : BaseApiController<UserMemberInfo>
    {
        public override void CheckUserLogin()
        {
            ...
            {
                throw new HimallApiException(ApiErrorCode.Invalid_User_Key_Info, "用户己被冻结");
            }
        }
