...
namespace Himall.API
{
    public class OrderRefundController : BaseApiController
    {
        ...
        public object GetRefundDetail(long id)
        {
            ...
            d.CertPic1 = Himall.Core.HimallIO.GetRomoteImagePath(refundinfo.CertPic1);
            d.CertPic2 = Himall.Core.HimallIO.GetRomoteImagePath(refundinfo.CertPic2);
            d.CertPic3 = Himall.Core.HimallIO.GetRomoteImagePath(refundinfo.CertPic3);
