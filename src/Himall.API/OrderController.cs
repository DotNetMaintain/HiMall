...
namespace Himall.API
{
    public class OrderController : BaseApiController
    {
        ...
        public object GetSubmitModel(string skuId, int count, long shippingAddressId = 0, string couponIds = "")
        {
            ...
            d.ProvideInvoice = OrderApplication.HasProvideInvoiceShop(result.products.Select(s => s.shopId).Distinct());
            ...
            d.userIntegralMaxRate = SiteSettingApplication.GetSiteSettings().IntegralDeductibleRate;
        ...
        public object PostSubmitOrder(OrderSubmitOrderModel value)
        {
            ...
            model.Capital = capitalAmount;//预付款
        ...
        public object GetGroupOrderModel(string skuId, int count, long GroupActionId, long? GroupId = null)
        {
            ...
            if (result.Address != null)
            {
                ...
                d.Address.MemberInfo = new UserMemberInfo();
            }
