...
namespace Himall.Service
{
    public class WXMsgTemplateService : ServiceBase, IWXMsgTemplateService
    {
        ...
        public QueryPageModel<SendMessageRecordInfo> GetSendRecords(SendRecordQuery query)
        {
        ...
        public WeiXinMsgTemplateInfo GetWeiXinMsgTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type)
        {
            ...
            Core.Log.Debug("msgtype"+ msgtype);
            ...
            Core.Log.Debug("result" + result.IsOpen);
        ...
        /// </summary>
        /// <returns></returns>
        public List<WeiXinMsgTemplateInfo> GetWeiXinMsgTemplateListByApplet(bool iso2o = false)
        {
            List<WeiXinMsgTemplateInfo> result = new List<WeiXinMsgTemplateInfo>();
            result = Context.WeiXinMsgTemplateInfo.Where(d => d.UserInWxApplet == (iso2o ? WXMsgTemplateType.O2OApplet : WXMsgTemplateType.Applet)).ToList();
            bool isHaveSave = false;
            //初始表
            ...
            foreach (var item in _wxmsglist)
            {
                ...
                {
                    isHaveSave = true;
                    result.Add(GetWeiXinMsgTemplateByApplet(item.MsgType, iso2o));
                }
                else
                {
                    if (_tmpmsg.TemplateNum != item.MsgTemplateShortId)
        ...
        /// <returns></returns>
        public WeiXinMsgTemplateInfo GetWeiXinMsgTemplateByApplet(Himall.Core.Plugins.Message.MessageTypeEnum type, bool iso2o = false)
        {
            int msgtype = (int)type;
            WeiXinMsgTemplateInfo result = Context.WeiXinMsgTemplateInfo.Where(d => d.UserInWxApplet == (iso2o ? WXMsgTemplateType.O2OApplet : WXMsgTemplateType.Applet)).FirstOrDefault(d => d.MessageType == msgtype);
            ...
            if (result == null)
            {
                ...
                result.UpdateDate = DateTime.Now;
                result.IsOpen = true;
                result.UserInWxApplet = (iso2o ? WXMsgTemplateType.O2OApplet : WXMsgTemplateType.Applet);
                Context.WeiXinMsgTemplateInfo.Add(result);
                Context.SaveChanges();
            }
            return result;
            ...
            if (isdataok)
            {
                ...
                switch (type)
                {
                    ...
                    case Core.Plugins.Message.MessageTypeEnum.OrderShipping:
                        #region 订单发货(买家)
                        var _osmsgdata = new WX_MsgTemplateRefundDataModel();
                    ...
                    case Core.Plugins.Message.MessageTypeEnum.OrderRefundFail:
                        ...
                        _RefundFaildata.keyword2.value = "";//交易单号
                        _RefundFaildata.keyword2.color = data.keyword1.color;
                        ...
                        _RefundFaildata.remark.value = data.remark.value;
                    ...
                    case Core.Plugins.Message.MessageTypeEnum.FightGroupNewJoin:
                        ...
                        _fgnjmsgdata.keyword4.value = data.keyword2.value;
                        _fgnjmsgdata.keyword4.color = data.keyword2.color;
                        _fgnjmsgdata.keyword5.value = data.keyword1.value;
                        _fgnjmsgdata.keyword5.color = data.keyword1.color;
                        _fgnjmsgdata.remark.value = data.remark.value;
                        _fgnjmsgdata.remark.color = data.remark.color;
                    ...
                    case Core.Plugins.Message.MessageTypeEnum.FightGroupSuccess:
                        ...
                        #endregion
                        break;
                    //case Core.Plugins.Message.MessageTypeEnum.SendGood:
                    //    #region 发货提醒
                    //    var _fhsmsgdata = new WX_MsgTemplateRefundDataModel();
                    //    _fhsmsgdata.first.value = data.first.value;
                    //    _fhsmsgdata.first.color = data.first.color;
                    //    _fhsmsgdata.keyword1.value = data.keyword1.value;
                    //    _fhsmsgdata.keyword1.color = data.keyword1.color;
                    //    _fhsmsgdata.keyword2.value = data.keyword2.value;
                    //    _fhsmsgdata.keyword2.color = data.keyword2.color;
                    //    _fhsmsgdata.keyword3.value = data.keyword3.value;
                    //    _fhsmsgdata.keyword3.color = data.keyword3.color;
                    //    _fhsmsgdata.keyword4.value = data.keyword4.value;
                    //    _fhsmsgdata.keyword4.color = data.keyword4.color;
                    //    _fhsmsgdata.keyword5.value = data.keyword5.value;
                    //    _fhsmsgdata.keyword5.color = data.keyword5.color;
                    //    _fhsmsgdata.remark.value = data.remark.value;
                    //    _fhsmsgdata.remark.color = data.remark.color;
                    //    msgdata = _fhsmsgdata;
                    //    #endregion
                    //    break;
                    //case Core.Plugins.Message.MessageTypeEnum.InsuranceSuccess:
                    //    #region 保险成功
                    //    var _Insmsgdata = new WX_MsgTemplateRefundDataModel();
                    //    _Insmsgdata.first.value = data.first.value;
                    //    _Insmsgdata.first.color = data.first.color;
                    //    _Insmsgdata.keyword1.value = data.keyword1.value;
                    //    _Insmsgdata.keyword1.color = data.keyword1.color;
                    //    _Insmsgdata.keyword2.value = data.keyword2.value;
                    //    _Insmsgdata.keyword2.color = data.keyword2.color;
                    //    _Insmsgdata.keyword3.value = data.keyword3.value;
                    //    _Insmsgdata.keyword3.color = data.keyword3.color;
                    //    _Insmsgdata.keyword4.value = data.keyword4.value;
                    //    _Insmsgdata.keyword4.color = data.keyword4.color;
                    //    _Insmsgdata.keyword5.value = data.keyword5.value;
                    //    _Insmsgdata.keyword5.color = data.keyword5.color;
                    //    _Insmsgdata.remark.value = data.remark.value;
                    //    _Insmsgdata.remark.color = data.remark.color;
                    //    msgdata = _Insmsgdata;
                    //    #endregion
                    //    break;
                    default:
...
#if DEBUG
                Core.Log.Debug("[模板消息]取到Token"+ accessToken);
                Core.Log.Debug("[模板消息]取到openId" + openId);
                Core.Log.Debug("[模板消息]取到templateId" + templateId);
                Core.Log.Debug("[模板消息]取到accessToken" + accessToken);
                Core.Log.Debug("[模板消息]取到appsecret" + appsecret);
#endif
                Core.Log.Debug("url" + url);
                var _result = TemplateApi.SendTemplateMessage(accessToken, openId, templateId, topcolor, url, msgdata);
                Core.Log.Debug("[模板消息]取到_result" + _result.errcode);
                //小程序发送消息接口
        ...
        public string GetMessageTemplateShowUrl(Himall.Core.Plugins.Message.MessageTypeEnum type)
        {
            ...
            if (_tmplinkdata != null)
            {
                ...
                {
                    result = System.Configuration.ConfigurationManager.AppSettings["CurDomainUrls"];
        ...
        /// </summary>
        /// <returns></returns>
        public WeiXinMsgTemplateInfo GetWXAppletMsgTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type, bool iso2o = false)
        {
            int msgtype = (int)type;
            WeiXinMsgTemplateInfo result = Context.WeiXinMsgTemplateInfo.FirstOrDefault(d => d.MessageType == msgtype && d.UserInWxApplet == (iso2o ? WXMsgTemplateType.O2OApplet : WXMsgTemplateType.Applet));
            return result;
        }
        ...
        /// <param name="url"></param>
        /// <param name="openid">与userid配合使用，userid为0时使用此字段</param>
        public void SendAppletMessageByTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type, long userId, WX_MsgTemplateSendDataModel data, string url = "", string wxopenid = "", string formId = "", bool iso2o = false)
        {
            var siteSetting = Himall.ServiceProvider.Instance<ISiteSettingService>.Create.GetSiteSettings();
            ...
            if (iso2o)
            {
                appid = siteSetting.WeixinO2OAppletId;
                appsecret = siteSetting.WeixinO2OAppletSecret;
            }
            if (string.IsNullOrWhiteSpace(appid) || string.IsNullOrWhiteSpace(appsecret))
            {
                throw new HimallException("未配置微信公众信息");
            ...
            string dataerr = "";
#if DEBUG
            Core.Log.Info("[" + (iso2o ? "o2o" : "商城") + "小程序模板消息]开始准备数据：" + userId.ToString() + "[" + type.ToDescription() + "]");
#endif
            bool isdataok = true;
            string openId = wxopenid;
            if (userId == 0)
            {
                if (string.IsNullOrWhiteSpace(wxopenid))
                {
                    throw new HimallException((iso2o ? "o2o" : "商城") + "小程序：错误的OpenId");
                }
                openId = wxopenid;
            }
            else
            ...
            var _msgtmplinfo = GetWeiXinMsgTemplateByApplet(type, iso2o);
            if (_msgtmplinfo == null)
            {
                dataerr = (iso2o ? "o2o" : "商城") + "消息模板未取到";
                isdataok = false;
            }
            string templateId = "";
            string topcolor = "#000000";
            ...
            {
#if DEBUG
                Core.Log.Info((iso2o ? "o2o" : "商城") + "[小程序：模板消息]开始发送前");
#endif
                object msgdata;
                switch (type)
                {
...
#if DEBUG
                Core.Log.Info((iso2o ? "o2o" : "商城") + "[小程序：模板消息]开始发送到openid:" + openId);
#endif
                var wxhelper = new Weixin.WXHelper();
                Log.Info((iso2o ? "o2o" : "商城") + "小程序：appid:" + appid+ "，appsecret:"+ appsecret);
                var accessToken = wxhelper.GetAccessToken(appid, appsecret);
#if DEBUG
                Core.Log.Info((iso2o ? "o2o" : "商城") + "[小程序：模板消息]取到Token");
#endif
                Core.Log.Info((iso2o ? "o2o" : "商城") + "[小程序：模版消息]发送开始:" + " openId<" + openId + "> Url=<" + url + "> formId<" + formId + ">");
            ...
            {
#if DEBUG
                Core.Log.Info((iso2o ? "o2o" : "商城") + "[小程序：模板消息]发送失败：数据验证未通过-" + dataerr + "[" + type.ToDescription() + "]");
#endif
            }
        }
