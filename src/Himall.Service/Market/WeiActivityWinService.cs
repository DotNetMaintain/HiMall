...
namespace Himall.Service
{
    ...
    {
        public QueryPageModel<WeiActivityWinInfo> Get(string text,long id, int pageIndex, int pageSize)
        {
            ...
            QueryPageModel<WeiActivityWinInfo> pageModel = new QueryPageModel<WeiActivityWinInfo>()
            {
                Models = datas.ToList(),
                Total = total
            };
