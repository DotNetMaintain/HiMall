...
namespace Himall.Service
{
    public class MarketService : ServiceBase, IMarketService
    {
        ...
        public QueryPageModel<MarketServiceRecordInfo> GetBoughtShopList(MarketBoughtQuery query)
        {
            ...
            int total = 0;
            markets = markets.GetPage(d => d.OrderByDescending(o => o.Id), out total, query.PageNo, query.PageSize);
            QueryPageModel<MarketServiceRecordInfo> pageModel = new QueryPageModel<MarketServiceRecordInfo>() { Models = markets.ToList(), Total = total };
            return pageModel;
        }
