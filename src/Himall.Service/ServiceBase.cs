...
namespace Himall.Service
{
    public class ServiceBase
    {
        ...
        #region 属性
        protected Himall.Entity.Entities Context
        {
            get
            {
                ...
                var entities = CallContext.GetData(name) as Himall.Entity.Entities;
        ...
        /// 没有延迟加载，没有代理的上下文
        /// </summary>
        protected Himall.Entity.Entities NoLazyNoProxyContext
        {
            get
            {
