...
namespace Himall.Service
{
    public class CategoryService : ServiceBase, ICategoryService
    {
        ...
        public void UpdateCategoryName(long id, string name)
        {
            ...
            var category = Context.CategoryInfo.FirstOrDefault(p => p.Id == id);
        ...
        {
            var category = Context.CategoryInfo.FirstOrDefault(p => p.Id == model.Id);
        ...
        public QueryPageModel<CategoryInfo> GetCategoryByName(string name, int pageNo, int pageSize)
        {
            int total = 0;
            ...
            QueryPageModel<CategoryInfo> pageModel = new QueryPageModel<CategoryInfo>() { Models = categories.ToList(), Total = total };
            return pageModel;
        }
    }
}
