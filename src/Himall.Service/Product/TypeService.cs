...
namespace Himall.Service
{
    ...
    public class TypeService : ServiceBase, ITypeService
    {
        ...
        {
            var actualModel = Context.ProductTypeInfo.FirstOrDefault(p => p.Id == model.Id);
        ...
        private void ProcessingSpecificationValues(ProductTypeInfo model)
        {
            ...
            var _model = Context.ProductTypeInfo.FirstOrDefault(p => p.Id == model.Id);
            //颜色
        ...
        {
            var actual = Context.ProductTypeInfo.FirstOrDefault(p => p.Id == model.Id);
