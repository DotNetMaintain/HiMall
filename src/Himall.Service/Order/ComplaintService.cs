...
namespace Himall.Service
{
    ...
    {
        public QueryPageModel<OrderComplaintInfo> GetOrderComplaints(ComplaintQuery complaintQuery)
        {
            int total;
            ...
            complaints = complaints.GetPage(d => d.OrderByDescending(o => o.Id), out total, complaintQuery.PageNo, complaintQuery.PageSize);
            QueryPageModel<OrderComplaintInfo> pageModel = new QueryPageModel<OrderComplaintInfo>() { Models = complaints.ToList(), Total = total };
            return pageModel;
        }

        public void DealComplaint(long id)
        {
            OrderComplaintInfo orderComplaint = Context.OrderComplaintInfo.FirstOrDefault(p => p.Id == id);
