...
namespace Himall.Service
{
    public class PhotoSpaceService : ServiceBase, IPhotoSpaceService
    {
        ...
        public QueryPageModel<Model.PhotoSpaceInfo> GetPhotoList(string keyword, int pageIndex, int pageSize, int order, long categoryId = 0, long shopId = 0)
        {
            ...
            QueryPageModel<PhotoSpaceInfo> pageModel = new QueryPageModel<PhotoSpaceInfo>() { Models = complaints.ToList(), Total = total };
            return pageModel;
        }
