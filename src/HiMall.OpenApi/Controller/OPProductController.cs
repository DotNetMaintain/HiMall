...
namespace Himall.OpenApi
{
    ...
    public class ProductController : HiOpenAPIController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public object UpdateProductQuantity([FromUri]UpdateProductQuantityParameterModel para)
        {
            #region 参数初始
            if(para==null)
            {
        ...
        /// </summary>
        [HttpPost]
        public object UpdateProductApproveStatus([FromUri]UpdateProductApproveStatusParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
