...
namespace Himall.OpenApi
{
    ...
    /// </summary>
    [RoutePrefix("OpenApi")]
    public class UserController : HiOpenAPIController
    {
        ...
        /// <returns></returns>
        public object GetUsers([FromUri]GetUsersUserParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
        ...
        /// <param name="para"></param>
        /// <returns></returns>
        public object GetUser([FromUri]GetUserUserParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
        ...
        public object AddUser(AddUserUserParameterModel para)
        {
            ...
            if (data != null)
            {
                throw new HimallApiException(OpenApiErrorCode.Parameter_Error, "user_name");
            }
        ...
        private void CheckShopAuthority(string app_key)
        {
            ...
            {
                throw new HimallApiException(OpenApiErrorCode.Invalid_App_Key, "appkey");
            }
        }
