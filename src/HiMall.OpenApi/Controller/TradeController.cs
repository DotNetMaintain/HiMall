...
namespace Himall.OpenApi
{
    ...
    public class TradeController : HiOpenAPIController
    {
        ...
        public object GetTrade([FromUri]GetTradeParameterModel para)
        {
            ...
            return TJson(new { trade_get_response = new { trade = result } });
        }
        /// <summary>
        /// 修改交易备注
        /// </summary>
        ...
        public object UpdateTradeMemo(UpdateTradeMemoParameterModel para)
        {
            ...
            return TJson(new { trade_memo_update_response = new { trade = new { tid = para.tid, modified = result } } });
        }
        /// <summary>
        /// 订单发货
        /// </summary>
        ...
        /// <returns></returns>
        [HttpGet]
        public object SendLogistic([FromUri]SendLogisticParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
            ...
            return TJson(new { logistics_send_response = new { shipping = new { is_success = result } } });
        }
        /// <summary>
        /// 更新物流信息
        /// </summary>
        ...
        /// <returns></returns>
        [HttpGet]
        public object ChangLogistics([FromUri]ChangLogisticsParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
            ...
            return TJson(new { logistics_change_response = new { shipping = new { is_success = result } } });
        }
    }
}
