...
{
    [O2OApiExceptionFilter]
    public class BaseO2OApiController<TUser> : HiAPIController<TUser>
    {
        /// <summary>
        /// 检测用户登录信息是否有效
        /// </summary>
        ...
        /// <returns></returns>
        public JsonResult<Result<int>> GetPhoneOrEmailCheckCode(string contact, string id = null, string imageCheckCode = null)
        {
            if (CurrentUser == null)
            {
    ...
    public class BaseO2OApiController : BaseO2OApiController<UserMemberInfo>
    {
        /// <summary>
        /// 微信小程序信任登录服务标识
        /// </summary>
        public const string O2OSmallProgServiceProvider = "O2OWeiXinSmallProg";
        ...
        protected override UserMemberInfo GetUser()
        {
            ...
            {
                var userInfo = Application.MemberApplication.GetMemberByOpenId(O2OSmallProgServiceProvider, openId);
                return userInfo;
            }
