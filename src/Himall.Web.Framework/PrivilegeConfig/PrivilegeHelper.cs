        ...
        public static Privileges GetPrivileges<TEnum>()
        {
            ...
            foreach (var field in fields)
            {
                ...
                if (sitesetting != null)
                {
                    ...
                    {
                        if (groupInfo.GroupName == "分销")
                        {
                            if (groupInfo.Name == "分销规则管理" && groupInfo.Pid == 10001)
                                continue;
                            if (groupInfo.Name == "分销业绩管理" && groupInfo.Pid == 10002)
                                continue;
                        }
                        if (groupInfo.GroupName == "微信")
                        {
                            ...
                            if (groupInfo.Name == "微信菜单" && groupInfo.Pid == 8003)
                                continue;
                            if (groupInfo.Name == "iBeacon设备" && groupInfo.Pid == 8005)
                                continue;
                    ...
                    if (!(sitesetting.IsOpenMultiStoreSmallProg || sitesetting.IsOpenStore))
                    {
                        if (groupInfo.GroupName == "店铺")
                        {
                    ...
                    if (!(sitesetting.IsOpenPC || sitesetting.IsOpenH5 || sitesetting.IsOpenApp || sitesetting.IsOpenMallSmallProg || sitesetting.IsOpenMultiStoreSmallProg))
                    {
                        if (groupInfo.GroupName == "营销")
                        {
            ...
            foreach (var field in fields)
            {
                ...
                if (sitesetting != null)
                {
                    ...
                    if (!sitesetting.IsOpenH5)//H5端未开启授权
                    {
                        ...
                        if (groupInfo.GroupName == "分销")
                        {
                            if (groupInfo.Name == "分销市场管理" && groupInfo.Pid == 7101)
                                continue;
                            if (groupInfo.Name == "销售员管理" && groupInfo.Pid == 7102)
                                continue;
                            if (groupInfo.Name == "分销业绩管理" && groupInfo.Pid == 7103)
                                continue;
                            if (groupInfo.Name == "分销首页设置" && groupInfo.Pid == 7104)
                                continue;
                        }
                    ...
                    if (!(sitesetting.IsOpenPC || sitesetting.IsOpenH5 || sitesetting.IsOpenApp))
                    {
                        if (groupInfo.GroupName == "营销")
                        {
                            if (groupInfo.Name == "注册送优惠券" && groupInfo.Pid == 9013)//新人礼包
                                continue;
                        }
                    }
                    if (!(sitesetting.IsOpenH5 || sitesetting.IsOpenApp))
