...
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8 COMMENT='营销活动表';
...
) ENGINE=InnoDB AUTO_INCREMENT=680 DEFAULT CHARSET=utf8 COMMENT='营销活动商品';
...
CREATE TABLE `Himall_AppMessages` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1599 DEFAULT CHARSET=utf8 COMMENT='APP消息通知表';
...
) ENGINE=InnoDB AUTO_INCREMENT=853 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6505 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=4356 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=883 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
-- ----------------------------
-- Table structure for Himall_CouponProducts
-- ----------------------------
DROP TABLE IF EXISTS `Himall_CouponProducts`;
CREATE TABLE `Himall_CouponProducts` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `himall_couponproducts_ibfk_1` FOREIGN KEY (`CouponId`) REFERENCES `Himall_Coupon` (`Id`),
  CONSTRAINT `himall_couponproducts_ibfk_2` FOREIGN KEY (`ProductId`) REFERENCES `Himall_Products` (`Id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2300 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='注册送优惠券关联优惠券';
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='分销首页显示商品';
...
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 COMMENT='分销用户与店铺关联表';
...
CREATE TABLE `Himall_FightGroupActive` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 COMMENT='拼团活动';
...
CREATE TABLE `Himall_FightGroupActiveItem` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=314 DEFAULT CHARSET=utf8 COMMENT='拼团活动项';
...
CREATE TABLE `Himall_FightGroupOrder` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=338 DEFAULT CHARSET=utf8 COMMENT='拼团订单';
...
CREATE TABLE `Himall_FightGroups` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=324 DEFAULT CHARSET=utf8 COMMENT='拼团组团详情';
...
) ENGINE=InnoDB AUTO_INCREMENT=7524 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=580 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=659 DEFAULT CHARSET=utf8 COMMENT='满减规则';
...
) ENGINE=InnoDB AUTO_INCREMENT=2450 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_HomeFloors` (
  ...
  `CommodityStyle` int(11) DEFAULT NULL COMMENT '商品样式，0：默认，1：一排5个，2：一排4个',
  `DisplayMode` int(11) DEFAULT NULL COMMENT '显示方式，0=默认，1=平铺展示，2=左右轮播',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `Himall_ImageAds` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=7425 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Logs` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=7075 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Managers` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=453 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3660 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1215 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=737 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_MessageLog` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2354 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=765 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3945 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2986 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_OrderPay` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2113 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_OrderRefundLogs` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1163 DEFAULT CHARSET=utf8 COMMENT='订单售后日志表';
...
CREATE TABLE `Himall_PendingSettlementOrders` (
  ...
  `PaymentTypeName` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='待结算订单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=652 DEFAULT CHARSET=utf8 COMMENT='平台资金流水表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6303 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1083 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
-- ----------------------------
-- Table structure for Himall_ProductLadderPrices
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ProductLadderPrices`;
CREATE TABLE `Himall_ProductLadderPrices` (
...
-- ----------------------------
-- Table structure for Himall_Insurance
-- ----------------------------
DROP TABLE IF EXISTS `Himall_Insurance`;
CREATE TABLE `himall_Insurance` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Insurance_informed_consent` varchar(200) NOT NULL COMMENT '保险知情同意书',
  `Insurance_company` varchar(200) NOT NULL COMMENT '保险公司',
  `Insurance_age` varchar(100) NOT NULL COMMENT '保险适用年龄',
  PRIMARY KEY (`Id`)
)
-- ----------------------------
...
CREATE TABLE `Himall_ProductRelationProducts` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='推荐商品';
...
) ENGINE=InnoDB AUTO_INCREMENT=1609 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2534 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=8124 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1601 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=446 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Table structure for Himall_ShippingFreeGroups
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ShippingFreeGroups`;
CREATE TABLE `Himall_ShippingFreeGroups` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for Himall_ShippingFreeRegions
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ShippingFreeRegions`;
CREATE TABLE `Himall_ShippingFreeRegions` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Himall_ShopAccount` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='店铺资金表';
...
) ENGINE=InnoDB AUTO_INCREMENT=379 DEFAULT CHARSET=utf8 COMMENT='店铺资金流水表';
...
) ENGINE=InnoDB AUTO_INCREMENT=26524 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShopBranch` (
  ...
  `IsAutoPrint` bit(1) DEFAULT NULL COMMENT '是否开启自动打印',
  `PrintCount` int(11) DEFAULT NULL COMMENT '打印张数',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='门店信息表';
...
CREATE TABLE `Himall_ShopBranchManagers` (
  ...
  `RealName` varchar(1000) DEFAULT NULL COMMENT '真实名称',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8 COMMENT='门店管理员表';
...
CREATE TABLE `Himall_ShopBranchSkus` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1059 DEFAULT CHARSET=utf8 COMMENT='商家分店SKU信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=280 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShopCategories` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=447 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShopDistributorSetting` (
  ...
  `DisShopBanner` varchar(255) DEFAULT NULL COMMENT '分销店铺banner',
  PRIMARY KEY (`Id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2788 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShopRenewRecord` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='店铺续费记录表';
...
CREATE TABLE `Himall_Shops` (
  ...
  `IsAutoPrint` bit(1) DEFAULT NULL COMMENT '商家是否开启自动打印',
  `PrintCount` int(11) DEFAULT NULL COMMENT '打印张数',
  PRIMARY KEY (`Id`),
...
-- ----------------------------
-- Table structure for Himall_ShopShippers
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ShopShippers`;
CREATE TABLE `Himall_ShopShippers` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ShopId` bigint(20) NOT NULL COMMENT '商家编号',
...
CREATE TABLE `Himall_ShopVistis` (
  ...
  `StatisticFlag` bit(1) NOT NULL COMMENT '是否已经统计(0：未统计,1已统计)',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=4027 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=7181 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=225 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Theme` (
  ...
  `IsUse` bit(1) DEFAULT NULL COMMENT '是否将主题配色应用至商城',
  PRIMARY KEY (`ThemeId`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2048 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
