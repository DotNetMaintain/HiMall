        ...
        if (cart.products.length == 0) {
            ...
            $.each(data, function (i, e) {
                ...
                $.each(e.product, function (j, product) {
                    if (product.productstatus != strproductstatus || product.status == 1) {
                        str += '\
                        <div class="item item_disabled ">\
                          <div class="item_form cl">\
                            <div class="cell p-checkbox">\
                              <span status=' + product.productstatus + ' name="checkItem" class="checkbox">' + ((product.productstatus == 0 || product.status==1) ? '失效' : '已售罄') + '</span>\
                            </div>'
                    } else {
