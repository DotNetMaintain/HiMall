    ...
    if (select != "") {
        ...
        if (parseInt(cityid) > 0 && isFree == "0") {
            ...
            $.ajax({
                type: 'post',
                url: '../CalceFreight',
                data: { cityId: streetId, streetId: streetId, pId: gid, count: totalnum, skuId: hidskuid },
                dataType: "json",
                async: false,
            ...
            if (address != "") {
                ...
                if (parseInt(cityid) > 0 && isFree == "0") {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '../CalceFreight',
                        data: { cityId: streetId, streetId: streetId, pId: gid, count: totalnum, skuId: $("#hidskuId").val() },
                        dataType: "json",
                        async: false,
                        success: function (data) {
                            if (data.success == true) {
