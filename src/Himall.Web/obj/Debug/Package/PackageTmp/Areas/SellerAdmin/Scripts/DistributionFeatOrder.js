...
function reload(pageNo) {
    ...
    $("#list").hiMallDatagrid('reload', { orderid: orderid, ordstate: ordstate, sstate: ststate, salesid: sales, salesname: salesname, stime: stime, etime: etime, pageNumber: pageNo });
}
        ...
        [[
            {
                ...
                formatter: function (value, row, index) {
                    var html = '<span class="overflow-ellipsis" style="width:150px"><a title="' + value + '" target="_blank" href="../order/detail/' + value + '">' + value + '</a></span>';
                    return html;
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    var html = '<a title="' + value + '" target="_blank" href="/product/detail/' + row.ProductId + '"><span class="overflow-ellipsis" style="width:300px">' + value + '</span><span style="display:block;color:#666;">' + row.SkuText + '</span></a>';
                    return html;
                }
            },
