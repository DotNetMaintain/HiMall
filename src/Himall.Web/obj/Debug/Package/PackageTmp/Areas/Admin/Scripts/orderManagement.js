...
$(function () {
    ...
    $("#list").hiMallDatagrid({
		...
		{ field: "ShopName", title: "店铺/门店", width: 140, align: "center" },
...
function ExportExecl() {
    ...
    var href = "/Admin/Order/ExportToExcel?status={0}&startDate={1}&endDate={2}&orderId={3}&shopName={4}&userName={5}&paymentTypeGateway={6}&paymentType={7}&userContact={8}&orderType={9}&shopBranchName={10}"
	.format(status, startDate, endDate, orderId, shopName, userName, paymentTypeGateway, selectPaymentType, txtUserContact, orderType,shopBranchName);
