    ...
    ; (function (win, doc) {
        ...
        doc.getElementById('ids').onclick = function () {
            ...
            jQuery.ajax({
                type: 'POST',
                url: 'Save',
                data: { elements: JSON.stringify(arr), name: expressTemplateName, width: jQuery('#imageweight').val(), height: 480, backimage: jQuery('#id_img').val() },
                dataType: "json",
                success: function (data) {
                    if (data.success)
