...
namespace Himall.Web.Areas.Web.Controllers
{
    public class IntegralMallController : BaseWebController
    {
        ...
        public ActionResult Index()
        {
            ...
            QueryPageModel<CouponInfo> coupons = _iCouponService.GetIntegralCoupons(1, result.CouponPageSize);
        ...
        {
            QueryPageModel<CouponInfo> coupons = _iCouponService.GetIntegralCoupons(page, rows);
