...
function chooseJumpUrl() {
    ...
    switch (selectValue) {
        case "1":
            ...
            title = "门店标签";
            desc = "描述";
            jumpUrl = "https://" + window.location.host + "/m-wap/ShopBranch/Tags/{0}";
            break;
        case "2":
            queryUrl = "/admin/NearShopBranch/ShopList";
            title = "门店";
            desc = "标签";
            jumpUrl = "https://" + window.location.host + "/m-wap/ShopBranch/Index/{0}";
            break;
        case "3":
            queryUrl = "/admin/MobileTopic/list";
            title = "专题";
            desc = "标签";
            jumpUrl = "https://" + window.location.host + "/m-wap/topic/detail/{0}";
            break;
    }
