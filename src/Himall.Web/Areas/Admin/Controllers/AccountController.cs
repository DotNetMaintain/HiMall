...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class AccountController : BaseAdminController
    {
        ...
        {
            AccountInfo account = AccountApplication.GetAccount(id);
        ...
        public JsonResult List(int status, string shopName, int page, int rows)
        {
            ...
            QueryPageModel<AccountInfo> accounts = AccountApplication.GetAccounts(queryModel);
        ...
        public JsonResult DetailList(long accountId, int enumOrderTypeId, DateTime? startDate, DateTime? endDate, int page, int rows)
        {
            ...
            QueryPageModel<AccountDetailInfo> accountDetails = AccountApplication.GetAccountDetails(queryModel);
        ...
        public JsonResult MetaDetailList(long accountId, int enumOrderTypeId, DateTime? startDate, DateTime? endDate, int page, int rows)
        {
            ...
            QueryPageModel<AccountMetaModel> pageModelMetaInfo = AccountApplication.GetAccountMeta(queryModel);
        ...
        public JsonResult BrokerageDetailList(long accountId, DateTime? startDate, DateTime? endDate, int page, int rows)
        {
            ...
            QueryPageModel<BrokerageModel> list = AccountApplication.GetBrokerageList(queryModel);
        ...
        {
            SiteSettingApplication.SaveSetting("WeekSettlement", weekSettlementModel.NewWeekSettlement);
