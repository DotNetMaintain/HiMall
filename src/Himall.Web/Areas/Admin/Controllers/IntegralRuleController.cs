...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class IntegralRuleController : BaseAdminController
    {
        ...
        public IntegralRuleController(IMemberIntegralService iMemberIntegralService, ISiteSettingService iSiteSettingService)
        {
        ...
        public ActionResult Change()
        {
            ...
            var IntegralDeductibleRate = CurrentSiteSetting.IntegralDeductibleRate;
        ...
        public JsonResult Change(int IntegralPerMoney,int IntegralDeductibleRate)
        {
            ...
            _iMemberIntegralService.SetIntegralChangeRule(info);
            _iSiteSettingService.SaveSetting("IntegralDeductibleRate", IntegralDeductibleRate);
            return Json(new Result() { success = true, msg = "保存成功" });
        }
    }
}