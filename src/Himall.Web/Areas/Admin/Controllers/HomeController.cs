...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class HomeController : BaseAdminController
    {
        ...
        //    var ProductWaitForAuditing = ServiceApplication.Create<IProductService>().GetProducts(queryModel).Models.Count();
        ...
        //    var ShopWaitAudit = ServiceApplication.Create<IShopService>().GetShops(shopQueryModel).Models.Where(
        ...
        //    var BrandAudit = ServiceApplication.Create<IBrandService>().
        ...
        //    var ComplaintDispute = ServiceApplication.Create<IComplaintService>().GetOrderComplaints(complaintQueryModel).Models.Count();
        ...
        //        PageNo = 1
        //    };
        //    var RefundWaitAudit = ServiceApplication.Create<IRefundService>().GetOrderRefunds(orderQueryModel).Models.Count();
