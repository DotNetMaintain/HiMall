...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class DistributionMarketController : BaseAdminController
    {
        ...
        public ActionResult Setting()
        {
            ...
            ViewBag.IsAllUserShowDistributorTips = CurrentSiteSetting.IsAllUserShowDistributorTips;
            return View(m);
        }
        ...
        public ActionResult SaveSetting(Model.DistributorSettingInfo model)
        {
            ...
            var isallusershow = bool.Parse(Request.Form["isallusershow"]);
            SiteSettingApplication.SaveSetting("IsAllUserShowDistributorTips", isallusershow);
            return Json(new Result() { success = true, msg = "保存成功" });
        }
    }
}