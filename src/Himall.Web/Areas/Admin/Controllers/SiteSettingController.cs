    ...
    { /// <summary>
      ...
      /// </summary>
        ...
        public JsonResult Edit(SiteSettingModel siteSettingModel)
        {
            ...
            siteSetting.PageFoot = siteSettingModel.PageFoot;
            siteSetting.PCBottomPic = siteSettingModel.PCBottomPic;
            ...
            siteSetting.JDRegionAppKey = siteSettingModel.JDRegionAppKey;
