...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class HomeController : BaseSellerController
    {
       ...
       private IStatisticsService _iStatisticsService;
        ...
        //    var UnReplyConsultations = ServiceApplication.Create<IConsultationService>().GetConsultations(consultationsQuery).Models.Count();



        //    var UnPayOrder = ServiceApplication.Create<IOrderService>().GetOrders<OrderInfo>(
        //        new OrderQuery
        //        {
        //            PageNo = 1,
        //            PageSize = 10000,
        ...
        //        }).Models.Count();
        //    var UnDeliveryOrder = ServiceApplication.Create<IOrderService>().GetOrders<OrderInfo>(
        //        new OrderQuery
        //        {
        //            PageNo = 1,
        //            PageSize = 10000,
        ...
        //    var UnComplaints = ServiceApplication.Create<IComplaintService>().GetOrderComplaints(
        //        new ComplaintQuery
        //        {
        //            PageNo = 1,
        //            PageSize = 10000,
