...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    ...
    public class DistributionFeatController : BaseSellerController
    {
        ...
        public JsonResult GetOrderList(long? orderid = null, OrderInfo.OrderOperateStatus? ordstate = null, int? sstate = null, long? salesid = null, string salesname = "", DateTime? stime = null, DateTime? etime = null, int rows = 10, int page = 1)
        {
            ...
            //    {
            //        query.UserIds = _iMemberService.GetMembersByName(false, salesname).Where(a => a.Himall_Promoter.Count() > 0)
            //            .Select(a => a.Id);
            //    }
            //}
            query.UserName = salesname;
