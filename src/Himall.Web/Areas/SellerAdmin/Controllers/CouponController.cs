...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    ...
    public class CouponController : BaseSellerController
    {
        ...
        public ActionResult Add()
        {
            ...
            model.ShopId = shopId;
            var maxEndTime = _iMarketService.GetMarketService(CurrentSellerManager.ShopId, MarketType.Coupon).MarketServiceRecordInfo.Max(item => item.EndTime);
        ...
        public JsonResult Edit(CouponInfo info)
        {
            ...
            if (info.UseArea == 0)
            {
                info.Himall_CouponProducts = null;
                info.Remark = "";
            }
            if (isAdd)
            {
            ...
            if (info.UseArea == 1 && (info.Himall_CouponProducts == null || info.Himall_CouponProducts.Count() <= 0))
            {
