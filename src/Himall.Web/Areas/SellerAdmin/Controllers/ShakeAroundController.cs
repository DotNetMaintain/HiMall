...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class ShakeAroundController : BaseSellerController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return Redirect("/sellerAdmin/ShakeAround/UnConfig/您还未绑定微信公众号，需要绑定微信已认证服务号才可以使用摇一摇及门店管理相关功能。");
            }
            else if (!this._isdeploy)
            {
                return Redirect("/sellerAdmin/ShakeAround/UnConfig/access_token错误或失效，请确认AppId与AppSecret配置正确");
            }
            ...
            {
                return Redirect("/sellerAdmin/ShakeAround/Unauthorized");
            }
            return View();
        }
