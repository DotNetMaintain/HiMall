    ...
    public class ShopProfileController : BaseMemberController
    {
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            else if (CurrentSellerManager != null)
            {
                ...
                if ((shop.Stage != ShopInfo.ShopStage.Finish || shop.ShopStatus == ShopInfo.ShopAuditStatus.WaitConfirm) && filterContext.RequestContext.HttpContext.Request.HttpMethod.ToUpper() != "POST" && (shop.Stage != ShopInfo.ShopStage.Finish || string.IsNullOrEmpty(Request.QueryString["source"])))
                {
