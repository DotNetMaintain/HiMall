...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class ShopController : BaseSellerController
    {
        ...
        public ActionResult Invoice()
        {
            ...
            ViewBag.ProvideInvoice = shop.ProvideInvoice.HasValue ? shop.ProvideInvoice.Value : false;
        ...
        public JsonResult InvoiceSetting(bool enable)
        {
            ShopInfo shopInfo = new ShopInfo()
            {
                ...
                ProvideInvoice = enable//商家是否开启订单自动分配门店
            };
        ...
        public ActionResult Renew()
        {
            ...
            var enableGrade = _iShopService.GetShopGrades().Where(c => c.ChargeStandard >= shopGrade.ChargeStandard && c.Id != shopInfo.GradeId);//要排除自己
        ...
        public JsonResult PaymentList(decimal balance, int type, int value)
        {
            ...
            models = models.OrderByDescending(d=>d.Id).Where(item => !string.IsNullOrEmpty(item.RequestUrl) && item.Id != "Himall.Plugin.Payment.WeiXinPay" && item.Id != "Himall.Plugin.Payment.WeiXinPay_Native");//只选择正常加载的插件
            return Json(models);
        }
        ...
        public JsonResult Recordlist(int page, int rows)
        {
            ...
            QueryPageModel<ShopRenewRecord> accounts = _iShopService.GetShopRenewRecords(query);
        ...
        [HttpPost]
        public ActionResult UpRenew(ShopRenewRecord model)
        {
            if (model == null)
            ...
            if (model.Type == Himall.Model.ShopRenewRecord.EnumOperateType.ReNew)
            {
                model.OperateType = ShopRenewRecord.EnumOperateType.ReNew;
                ...
                if (shopInfo != null)
                {
                    ...
                    Cache.Remove(CacheKeyCollection.CACHE_SHOP(model.ShopId, false));
