...
function ExportExecl() {
    ...
    var href = "/SellerAdmin/Order/ExportToExcel?status={0}&startDate={1}&endDate={2}&orderId={3}&userName={4}&orderType={5}&paymentType={6}&userContact={7}&ShopBranchId={8}"
        .format(status, startDate, endDate, orderId, userName, orderType, selectPaymentType, txtUserContact, shopBranchId);
