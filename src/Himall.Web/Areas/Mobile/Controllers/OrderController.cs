...
{
    public class OrderController : BaseMobileTemplatesController
    {
        ...
        //public ActionResult InsuranceConsent(string hpvy, string hpvo)
        //{
        //    string str = "";
        //    var FilePath = Server.MapPath(@"~/Txt/");
...
        //            Console.WriteLine(strSence);
        ...
        //    //var fileName = Server.MapPath(@"~/Txt/");
        //    //string str = "";
        //    //if (hpvy != "" && hpvo == "")
        //    //{
        //    //    StreamReader sr = new StreamReader(fileName + hpvy, Encoding.Default);
        //    //    String line;
        ...
        //    //else if (hpvy == "" && hpvo != "")
        //    //{
        //    //    StreamReader sr = new StreamReader(fileName + hpvo, Encoding.Default);
        //    //    String line;
        //    //    while ((line = sr.ReadLine()) != null)
        //    //    {
        //    //        str += line;
        ...
        public ActionResult Submit(string skuIds, string counts, int islimit = 0, long shippingAddressId = 0, string couponIds = "")
        {
            try
            {
                ...
                ViewBag.HPVO = fileName + result.products[0].CartItemModels[0].HPVO;
                ViewBag.HPVY = fileName + result.products[0].CartItemModels[0].HPVY;
                ViewBag.Insurancey_age = result.products[0].CartItemModels[0].Insurancey_age;
                ViewBag.Insuranceo_age = result.products[0].CartItemModels[0].Insuranceo_age;
                var orderTag = Guid.NewGuid().ToString("N");
                ViewBag.OrderTag = orderTag;
                Session["OrderTag"] = orderTag;
