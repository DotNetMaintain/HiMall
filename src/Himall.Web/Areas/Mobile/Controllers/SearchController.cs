...
namespace Himall.Web.Areas.Mobile.Controllers
{
    public class SearchController : BaseMobileTemplatesController
    {
        ...
        public JsonResult GetSearchFilter(string keyword, long cid = 0, long b_id = 0, string a_id = "")
        {
            ...
            JsonResult json = Json<dynamic>(success: true, data: new { Attr = result.Attribute, Brand = result.Brand, Category = result.Category }); //json = Json(new { success = true, Attr = result.Attribute, Brand = result.Brand, Category = result.Category }, JsonRequestBehavior.AllowGet);
