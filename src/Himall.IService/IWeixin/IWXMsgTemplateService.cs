...
namespace Himall.IServices
{
    public interface IWXMsgTemplateService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<SendMessageRecordInfo> GetSendRecords(SendRecordQuery query);
        ...
        /// </summary>
        /// <returns></returns>
        List<WeiXinMsgTemplateInfo> GetWeiXinMsgTemplateListByApplet(bool iso2o = false);  
        /// <summary>
        /// 获取微信模板信息
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        WeiXinMsgTemplateInfo GetWXAppletMsgTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type, bool iso2o = false);
        ...
        /// <param name="url"></param>
        /// <param name="openid">与userid配合使用，userid为0时使用此字段</param>
        void SendAppletMessageByTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type, long userId, WX_MsgTemplateSendDataModel data, string url = "", string wxopenid = "", string formid = "", bool iso2o = false);
