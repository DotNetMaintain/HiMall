...
namespace Himall.IServices
{
    ...
    public interface IProductService : IService
    {
        ...
        /// </summary>
        /// <returns></returns>
        QueryPageModel<ProductInfo> GetProducts(ProductQuery productQueryModel);
        ...
        void AddProduct(long shopId, ProductInfo product, string[] pics, SKUInfo[] skus, ProductDescriptionInfo description, ProductAttributeInfo[] attributes, long[] goodsCategory, SellerSpecificationValueInfo[] sellerSpecifications, ProductLadderPricesInfo[] prices);
        ...
        void UpdateProduct(ProductInfo product, string[] pics, SKUInfo[] skus, ProductDescriptionInfo description, ProductAttributeInfo[] attributes, long[] goodsCategory, SellerSpecificationValueInfo[] sellerSpecifications, ProductLadderPricesInfo[] prices);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        ProductInfo GetInsurance(long id);
        /// <summary>
        /// 获取商品描述
        /// </summary>
        /// <param name="productId">商品编号</param>
        ...
        QueryPageModel<ProductInfo, SearchProductModel> SearchProductAndOtherModel(ProductSearch search);
        #endregion
