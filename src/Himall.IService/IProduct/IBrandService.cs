...
namespace Himall.IServices
{
    public interface IBrandService : IService
    {
        ...
        /// </summary>
        /// <param name="model"></param>
        void UpdateApplyBrand(ShopBrandApplysInfo model);
        ...
        void AuditBrand(long id, Himall.Model.ShopBrandApplysInfo.BrandAuditStatus status,string remark);
        ...
        /// <returns></returns>
        List<BrandInfo> GetBrands(string keyWords, long shopId = 0, string action = "add");
        ...
        /// <returns></returns>
        QueryPageModel<ShopBrandApplysInfo> GetShopBrandApplys(long? shopId, int? auditStatus, int pageNo, int pageSize, string keyWords);
        ...
        ShopBrandApplysInfo GetExistApply(long shopId, string brandName);
    }
}
