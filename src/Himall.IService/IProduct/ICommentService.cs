...
namespace Himall.IServices
{
    public interface ICommentService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<ProductCommentInfo> GetComments(CommentQuery query);
        ...
        QueryPageModel<ProductEvaluation> GetProductEvaluation(CommentQuery query);
        ...
        /// <returns></returns>
        QueryPageModel<ProductCommentInfo> GetProductComments(ProductCommentQuery query);
        /// <summary>
        /// 获取商品评价数量聚合
        /// </summary>
        ...
        /// <returns></returns>
        ProductCommentCountAggregateModel GetProductCommentCountAggregate(long? productId = null, long? shopId = null, long? shopBranchId = null);
        /// <summary>
        /// 获取商品评价好评数
        /// </summary>
        /// <param name="productId"></param>
