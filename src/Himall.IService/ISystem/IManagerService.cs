...
namespace Himall.IServices
{
    public interface IManagerService : IService
    {
        ...
        /// <summary>
        /// 通过 openid 获取HimallMembers中的UserId
        /// </summary>
        /// <param name="userName"></param>
        /// <returns></returns>
        MyMemberOpenId GetByOpenId(string openid);
        /// <summary>
        /// 通过openid查询商城的用户信息
        /// </summary>
        /// <param name="userName"></param>
        /// <returns></returns>
        UserMember GetMemberByOpenID(string openid);
        /// <summary>
        /// 通过openid查询商城的用户信息
        /// </summary>
        /// <param name="userName"></param>
        /// <returns></returns>
        UserMember GetMemberByUserid(long userId);
        /// <summary>
        /// 根据商家名称获取商家信息
        /// </summary>
        /// <param name="userName"></param>
        /// <returns></returns>
        MyOrder GetOrderByUserIdAndOrderStatus(long userId);
        MyMemberOpenId getOpenIdByUserId(long userId);
    }
}
