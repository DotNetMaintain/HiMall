...
namespace Himall.IServices
{
    public interface IStatisticsService : IService
    {
        ...
        /// <returns></returns>
        LineChartDataModel<int> GetShopRankingChart(int year, int month, SaleDimension dimension= SaleDimension.SaleCount, int rankSize=15);
        ...
        /// <param name="rankSize">统计名次个数</param>
        /// <returns></returns>
        LineChartDataModel<int> GetShopRankingChart(int year, int month, int weekIndex, SaleDimension dimension = SaleDimension.SaleCount, int rankSize = 15);
        ...
        /// <param name="rankSize">统计名次个数</param>
        /// <returns></returns>
        LineChartDataModel<int> GetShopRankingChart(DateTime day, SaleDimension dimension = SaleDimension.SaleCount, int rankSize = 15);
