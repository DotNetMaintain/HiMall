...
namespace Himall.IServices
{
    public interface IMemberService : IService
    {
        ...
        /// <param name="serviceProvider">服务提供商</param>
        /// <returns></returns>
        UserMemberInfo QuickRegisters(string phone, string username, string realName, string nickName, string serviceProvider, string openId, string unionid = null, string sex = null, string headImage = null, MemberOpenIdInfo.AppIdTypeEnum appidtype = MemberOpenIdInfo.AppIdTypeEnum.Normal, string unionopenid = null, string city = null, string province = null);
        ...
        //根据用户名获取用户信息
        UserMemberInfo GetMemberByphone(string phone);
        ...
        /// <returns></returns>
        List<UserMemberInfo> GetMembersByName(bool status, string userName);
        ...
        UserMemberInfo GetMemberByUnionId(string OpenId);
        UserMemberInfo GetMemberByCellphone(string phone);
