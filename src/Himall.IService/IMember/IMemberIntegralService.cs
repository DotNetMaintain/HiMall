...
namespace Himall.IServices
{
    ...
    public interface IMemberIntegralService: IService
    {
        ...
        /// <param name="model"></param>
        /// <param name="conversionMemberIntegralEntity"></param>
        void AddMemberIntegralNotAddHistoryIntegrals(MemberIntegralRecord model, IConversionMemberIntegralBase conversionMemberIntegralEntity = null);
        /// <summary>
        ...
        /// <returns></returns>
        QueryPageModel<MemberIntegral> GetMemberIntegralList(IntegralQuery query);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<MemberIntegralRecord> GetIntegralRecordList(IntegralRecordQuery query);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<MemberIntegralRecord> GetIntegralRecordListForWeb(IntegralRecordQuery query);
