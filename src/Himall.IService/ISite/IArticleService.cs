...
namespace Himall.IServices
{
    public interface IArticleService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<ArticleInfo> Find(long? articleCategoryId, string titleKeyWords, int pageSize, int pageNumber, bool isShowAll=true);
        ...
        IQueryable<ArticleInfo> GetArticleByArticleCategoryIds(List<long> articleCategoryIds);
