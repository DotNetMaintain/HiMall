...
namespace Himall.IServices
{
    public interface IShopService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<ShopInfo> GetAuditingShops(ShopQuery shopQueryModel);
        ...
        /// <returns></returns>
        QueryPageModel<BusinessCategoriesApplyInfo> GetBusinessCateApplyList(BussinessCateApplyQuery query);
        ...
        #region 获取店铺续费记录
        QueryPageModel<ShopRenewRecord> GetShopRenewRecords(ShopQuery query);
        #endregion
        /// <summary>
        /// 冻结/解冻店铺
        /// </summary>
        ...
        void UpdateShopPrint(ShopInfo info);
    }
}
