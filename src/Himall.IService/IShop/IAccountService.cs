...
namespace Himall.IServices
{
    public interface IAccountService : IService
    {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<AccountPurchaseAgreementInfo> GetAccountPurchaseAgreements(AccountQuery query);
        /// <summary>
        /// 取服务费用
        /// </summary>
        /// <param name="query"></param>
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<BrokerageModel> GetBrokerageList(AccountQuery query);
