...
namespace Himall.IServices
{
    ...
    public interface IExpressService : IService
    {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<ExpressInfo> GetAllExpress();
        ...
        /// <returns></returns>
        ExpressInfo GetExpress(string name);
        /// <summary>
        /// 获取快递面单元素
        /// </summary>
        ...
        /// <param name="name">快递名称</param>
        void UpdateExpressAndElement(ExpressInfo express, ExpressElementInfo[] elements);
        /// <summary>
        /// 清除快递公司面单背景图片
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ExpressInfo ClearExpressData(long id);
        /// <summary>
        /// 获取店铺最近使用的快递信息
        /// </summary>
        ...
        /// <returns></returns>
        IEnumerable<ExpressInfo> GetRecentExpress(long shopId, int takeNumber);
        /// <summary>
        /// 获取快递物流信息
        /// </summary>
        ...
        /// </summary>
        /// <param name="model"></param>
        void AddExpress(ExpressInfo model);
        /// <summary>
        /// 更新快递公司第三方编号
        /// </summary>
        /// <param name="model"></param>
        void UpdateExpressCode(ExpressInfo model);
