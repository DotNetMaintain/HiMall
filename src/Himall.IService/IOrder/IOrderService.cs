...
namespace Himall.IServices
{
    ...
    public interface IOrderService : IService
    {
        ...
        /// <param name="productIds"></param>
        /// <returns></returns>
        Dictionary<long, int> GetProductBuyCountNotLimitBuy(long userId, IEnumerable<long> productIds);
        /// <summary>
        /// 是否存在订单
        /// </summary>
        /// <param name="orderId"></param>
        ...
        void PayCapitals(IEnumerable<long> orderIds, string payNo = null, long payId = 0);
        ...
        string GetTopOrderIds(long userId);
        string GetOrderIds(long userId);
        string GetTopOrderIds();
        OrderInfo GetOrdersByorderid(long orderid);
        ...
        void AgreeToRefundByBuyer(long orderId);
        /// <summary>
        /// 过期自动确认订单
        /// </summary>
