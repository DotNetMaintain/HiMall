...
namespace Himall.IServices
{
    ...
    public interface IRefundService : IService
    {
        ...
        /// <param name="userId"></param>
        /// <param name="shopId"></param>
        Orderrefunddetail Orderrefunddetail(long id);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        OrderRefundInfo GetOrderRefundById(long id);
		...
		string ConfirmRefund(long id, string managerRemark, string managerName, string notifyurl, decimal returnmoney);
		/// <summary>
		/// 异步通知确认退款
		/// </summary>
