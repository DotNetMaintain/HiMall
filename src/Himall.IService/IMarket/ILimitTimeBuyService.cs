...
namespace Himall.IServices
{
    ...
    public interface ILimitTimeBuyService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<ActiveMarketServiceInfo> GetBoughtShopList( MarketBoughtQuery query );
        ...
        /// <returns></returns>
        QueryPageModel<LimitTimeMarketInfo> GetItemList( LimitTimeQuery query );
        ...
        /// 后台分页取数据
        /// </summary>
        QueryPageModel<FlashSaleInfo> GetAll(  int status , string shopname , string title , int pageIndex , int pageSize, string productName);

        /// <summary>
        /// 店铺分页取某店数据
        /// </summary>
        QueryPageModel<FlashSaleInfo> GetAll(long shopid, int? status, string productName, DateTime? StartDate, DateTime? EndDate, int pageIndex, int pageSize);
        ...
        /// 获取正在进行的活动
        /// </summary>
        QueryPageModel<FlashSaleInfo> GetStartData( int index , int size , string cname ); 
