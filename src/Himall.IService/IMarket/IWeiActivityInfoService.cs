...
namespace Himall.IServices
{
    public interface IWeiActivityInfoService : IService
    {
        ...
        ///  查询刮刮卡
        /// </summary>
        QueryPageModel<WeiActivityInfo> Get(string text, WeiActivityType type, int pageIndex, int pageSize, bool? isIntegralActivity = null, bool isShowAll = true);
        ...
        ///// 获取刮刮卡
        ///// </summary>
        WeiActivityInfo GetActivityModel(long id, string url = "");
        /// <summary>
        /// 查询是否全部抽完
        /// </summary>
