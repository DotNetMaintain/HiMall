...
namespace Himall.IServices
{
    public interface IDistributionService : IService
    {
        ...
        //分页获取推广员列表
        QueryPageModel<PromoterInfo> GetPromoterList(PromoterQuery query);
        ...
        //获取分销列表
        QueryPageModel<ProductsDistributionModel> GetDistributionlist(DistributionQuery query);
        ...
        //获取业绩列表
        QueryPageModel<ProformanceModel> GetPerformanceList(ProformanceQuery query);

        //获取用户业绩详情
        QueryPageModel<UserProformanceModel> GetPerformanceDetail(UserProformanceQuery query);
        #endregion
        ...
        /// <returns></returns>
        QueryPageModel<object> GetDistributionOrders(dynamic query);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<object> GetDistributionProductsDetail(dynamic query);
        #endregion

        #region 个人中心
        void ApplyForDistributor(DistributionModel model);
        ...
        /// 
        /// <returns></returns>
        QueryPageModel<DistributionFeatModel> GetUserBillList(DistributionUserBillQuery query);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        QueryPageModel<object> GetUserAgentProducts(long userId);
        /// <summary>
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<ProductBrokerageInfo> GetDistributionProducts(ProductBrokerageQuery query);
        /// <summary>
        /// 获取分销商品信息
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<DistributionShopModel> GetShopDistributionList(DistributionShopQuery query);
        /// <summary>
        /// 获取店铺分销商品数量
