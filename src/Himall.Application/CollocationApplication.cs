...
namespace Himall.Application
{
    public class CollocationApplication
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static QueryPageModel<CollocationInfo> GetCollocationList(CollocationQuery query)
        {
        ...
        {
            return _iCollocationService.GetCollocationListByProductId(productId);
        }
    }
}
