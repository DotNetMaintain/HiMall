...
namespace Himall.Application
{
    public class MemberIntegralApplication
    {
        ...
        /// <returns></returns>
        public static QueryPageModel<MemberIntegral> GetMemberIntegralList(IntegralQuery query)
        {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static QueryPageModel<MemberIntegralRecord> GetIntegralRecordList(IntegralRecordQuery query)
        {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static QueryPageModel<MemberIntegralRecord> GetIntegralRecordListForWeb(IntegralRecordQuery query)
        {
