...
namespace Himall.Application
{
    public class ManagerApplication
    {
        ...
        /// <returns></returns>
        public static QueryPageModel<ManagerInfo> GetPlatformManagers(ManagerQuery query)
        {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static QueryPageModel<ManagerInfo> GetSellerManagers(ManagerQuery query)
        {
