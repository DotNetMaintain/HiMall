...
namespace Himall.Application
{
    public class WeiActivityApplication
    {
        ...
        public static QueryPageModel<WeiActivityModel> Get(string text, WeiActivityType type, int pageIndex, int pageSize, bool? isIntegralActivity = null, bool isShowAll = true)
        {
            QueryPageModel<WeiActivityInfo> weiInfo = _iActivityInfoService.Get(text, type, pageIndex, pageSize,  isIntegralActivity, isShowAll);
        ...
        {
            WeiActivityInfo model = _iActivityInfoService.GetActivityModel(id, url);
