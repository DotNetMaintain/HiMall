...
namespace Himall.Application
{
	...
	{
		private static IBrandService _brandService = ObjectContainer.Current.Resolve<IBrandService>();
		...
		public static void AuditBrand(long id, Himall.Model.ShopBrandApplysInfo.BrandAuditStatus status,string remark)
		{
			_brandService.AuditBrand(id, status, remark);
		}
        ...
        public static ShopBrandApplysInfo GetExistApply(long shopId, string brandName)
        {
            return _brandService.GetExistApply(shopId, brandName);
        }
    }
}
