...
namespace Himall.Application
{
    ...
    {
        static IMobileHomeProductsService _iMobileHomeProductsService = ObjectContainer.Current.Resolve<IMobileHomeProductsService>();
        ...
        /// <returns></returns>
        public static QueryPageModel<Model.MobileHomeProductsInfo> GetMobileHomePageProducts(long shopId, PlatformType platformType, int page, int rows, string keyWords, string shopName, long? categoryId = null)
        {
        ...
        /// <param name="platformType">平台类型</param>
        /// <returns></returns>
        public static IQueryable<MobileHomeProductsInfo> GetMobileHomePageProducts(long shopId, PlatformType platformType)
        {
            return _iMobileHomeProductsService.GetMobileHomePageProducts(shopId, platformType);
        }
        ...
        /// <returns></returns>
        public static QueryPageModel<Model.MobileHomeProductsInfo> GetSellerMobileHomePageProducts(long shopId, PlatformType platformType, int page, int rows, string brandName, long? categoryId = null)
        {
