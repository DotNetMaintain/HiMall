...
namespace Himall.Application
{
    public class MemberApplication
    {
        ...
        private static IMemberGradeService _memberGradeService = ObjectContainer.Current.Resolve<IMemberGradeService>();
        #endregion
        ...
        {
            Mapper.CreateMap<MemberContacts, Himall.Model.MemberContactsInfo>();
            var mm = Mapper.Map<MemberContacts, Himall.Model.MemberContactsInfo>(model);
        ...
        /// <returns></returns>
        public static MemberContacts GetMemberContactsInfo(string pluginId, string contact, Himall.Model.MemberContactsInfo.UserTypes type)
        {
            var model = MessageApplication.GetMemberContactsInfo(pluginId, contact, type);
            Mapper.CreateMap<Himall.Model.MemberContactsInfo, MemberContacts>();
            return Mapper.Map<Himall.Model.MemberContactsInfo, MemberContacts>(model);
        }
        ...
        public static Members GetMembers(long UserId)
        {
            ...
            // Mapper.CreateMap<Himall.Model.UserMemberInfo, Members>();
            // return Mapper.Map<Himall.Model.UserMemberInfo, Members>(model);

            var model = _iMemberService.GetMember(UserId);
            var m = Mapper.Map<Himall.Model.UserMemberInfo, Members>(model);
        ...
        public static long GetMemberGradeByUserId(long userId)
        {
            return _memberGradeService.GetMemberGradeByUserId(userId);
        }
        ...
        public static void UpdateOpenIdBindMember(MemberOpenIdInfo model)
        {
            _iMemberService.UpdateOpenIdBindMember(model);
        }
        ...
        /// <param name="UnionId"></param>
        /// <returns></returns>
        public static UserMemberInfo GetMemberByUnionId(string OpenId)
        {
            return _iMemberService.GetMemberByUnionId(OpenId);
        }
        /// <summary>
        /// 根据手机号取用户信息
        /// </summary>
        /// <param name="UnionId"></param>
        /// <returns></returns>
        public static UserMemberInfo GetMemberByCellphone(string OpenId)
        {
            return _iMemberService.GetMemberByCellphone(OpenId);
        }
        ...
        {
            _iMemberService.UpdateNetAmount(UserId, TotalAmount);
        }
        /// <summary>
        /// 增加会员表下单数
        /// </summary>
        ...
        {
            _iMemberService.IncreaseMemberOrderNumber(UserId);
        }
        ///// <summary>
        ///// 退款成功消息
        ///// </summary>
