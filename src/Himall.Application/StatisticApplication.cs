...
namespace Himall.Application
{
    ...
    public class StatisticApplication
    {
        ...
        public static void StatisticPlatVisitUserCount()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                lock (_platVisitLocker)
                {
                    ...
                    {
                        count = Core.Cache.Get<int>(CommonConst.HIMALL_PLAT_VISIT_COUNT);
                        count++;
                    }
        ...
        /// <returns></returns>
        public static MapChartDataModel GetAreaOrderChart(OrderDimension dimension, int year, int month)
        {
