...
namespace Himall.Application
{
    ...
    public class FullDiscountApplication
    {
        ...
        {
            QueryPageModel<ProductInfo> result = _iFullDiscountService.GetCanJoinProducts(shopId, productName, productCode, categoryId, isShopCategory, selectedProductIds, activeId, page, pagesize);
            return result;
        }
        /// <summary>
        /// 获取不在销售中的商品
