...
namespace Himall.Application
{
    public class MessageApplication
    {
        ...
        public static string SendMessageCode(string destination, string pluginId, MessageUserInfo info)
        {
            return _iMessageService.SendMessageCode(destination, pluginId, info);
        }
