...
namespace Himall.Application
{
    public class DistributionApplication
    {
        ...
        /// <returns></returns>
        public static Himall.DTO.DistributionProducts GetDistributionProductInfo(long productId, bool onlyNormal = false)
        {
            DistributionProducts result = null;
            var model = _iDistributionService.GetDistributionProductInfo(productId);
            if (model != null && onlyNormal && model.Status != Model.ProductBrokerageInfo.ProductBrokerageStatus.Normal)
            {
                model = null;
            }
            if (model != null)
