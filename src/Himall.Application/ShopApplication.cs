...
namespace Himall.Application
{
    public class ShopApplication
    {
        ...
        {
            Mapper.CreateMap<Settled, Himall.Model.SettledInfo>();
            var model = Mapper.Map<Settled, Himall.Model.SettledInfo>(mSettled);
            if (model.ID > 0)
            {
        ...
        public static Settled GetSettled()
        {
            ...
            {
                Mapper.CreateMap<Himall.Model.SettledInfo, Settled>();
                mSettled = Mapper.Map<Himall.Model.SettledInfo, Settled>(mSettledInfo);
            }
            return mSettled;
        }
        #endregion
        ...
        public static Shop GetShop(long id, bool businessCategoryOn = false)
        {
            if (Cache.Exists(CacheKeyCollection.CACHE_SHOPDTO(id, businessCategoryOn)))
                return Cache.Get<Shop>(CacheKeyCollection.CACHE_SHOPDTO(id, businessCategoryOn));

            var model = _iShopService.GetShop(id, businessCategoryOn);
            Shop mShop = new Shop();
            if (model != null)
            {
                mShop = Mapper.Map<Himall.Model.ShopInfo, Shop>(model);
            }
            Cache.Insert<Shop>(CacheKeyCollection.CACHE_SHOPDTO(id, businessCategoryOn), mShop, 600);
            return mShop;
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static ShopProfileStep2 GetShopProfileStep2(long id, out Himall.Model.ShopInfo.ShopStage Stage)
        {
            var shop = _iShopService.GetShop(id);
        ...
        {
            var mShop = Mapper.Map<Shop, Himall.Model.ShopInfo>(model);
        ...
        public static List<ShopGrade> GetShopGrades()
        {
            ...
            {
                Mapper.CreateMap<Himall.Model.ShopGradeInfo, ShopGrade>();
                lmShopGrade.Add(Mapper.Map<Himall.Model.ShopGradeInfo, ShopGrade>(item));
            }
            return lmShopGrade;
        }
        ...
        public static void UpdateWeChatAccount(WeChatAccount weChatAccount)
        {
        ...
        {
            return _iShopService.IsExpiredShop(shopId);
        }
        ...
        {
            return _iShopService.IsFreezeShop(shopId);
        }
        public static void UpdateShopPrint(ShopInfo info)
        {
            _iShopService.UpdateShopPrint(info);
        }
        ...
        /// <returns></returns>
        public static ShopWdgjSetting GetshopWdgjInfoByCode(string uCode)
        {
            return _iShopService.GetshopInfoByCode(uCode);
        }
        /// <summary>
        /// 获取网店管家信息
        /// </summary>
        /// <param name="shopId"></param>
        /// <returns></returns>
        public static ShopWdgjSetting GetshopWdgjInfoById(long shopId)
        {
            return _iShopService.GetshopWdgjInfoById(shopId);
        }
    }
}
