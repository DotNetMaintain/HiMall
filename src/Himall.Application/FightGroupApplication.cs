...
namespace Himall.Application
{
    ...
    public class FightGroupApplication
    {
        ...
        public static QueryPageModel<MarketServiceBuyRecordModel> GetMarketServiceBuyList(string shopName, int page = 1, int pagesize = 10)
        {
            ...
            QueryPageModel<MarketServiceRecordInfo> marketEntities = MarketApplication.GetBoughtShopList(queryModel);
        ...
        public static FightGroupGetSkuListModel GetNewActiveItems(long productId)
        {
            ...
            foreach (var item in pro.SKUInfo)
            {
                ...
                _data.ProductPrice = price > 0 ? price : item.SalePrice;
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public static Dictionary<long, int> GetMarketSaleCountForProductIdAndUserId(IEnumerable<long> productIds, long userId)
        {
            return _iFightGroupService.GetMarketSaleCountForProductIdAndUserId(productIds, userId);
        }
    }
}
