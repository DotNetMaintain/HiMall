...
namespace Himall.Plugin.Message.Email
{
    public class SendMail
    {
        ...
        public SendMail()
        {
            ...
            setSmtpClient(config.SmtpServer, Convert.ToInt32(config.SmtpPort),config.EnableSsl);
        ...
        private void setSmtpClient(string ServerHost, int Port,bool EnableSsl=false)
        {
